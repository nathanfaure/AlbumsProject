...
using AlbumsProject.Services.Interfaces;
using AlbumsProject.Utilities;
using AlbumsProject.ViewModels.ManageViewModels;
    ...
    public class ManageController : BaseController
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("AlbumsProject.Web"),
